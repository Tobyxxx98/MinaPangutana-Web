const CACHE='minapangutana-v2.1.1';
const ASSETS=['./','index.html','style.css','app.js','manifest.json','icons/icon-192.png','icons/icon-512.png','icons/icon-maskable-512.png','icons/apple-touch-icon-180.png','vendor/pdf.min.mjs','vendor/pdf.worker.min.mjs'];

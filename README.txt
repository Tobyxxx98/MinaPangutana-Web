MinaPangutana iOS-Ready v2.0

Shared PWA and Capacitor foundation for web, iPhone Home Screen, and a future
App Store build. Test locally with a web server; service-worker features do not
...
Read IOS_RELEASE_GUIDE.md before preparing the App Store version.

Developed by Cristopher Gonzaga
Creator & Developer of MinaPangutana
© 2026 Cristopher Gonzaga. All rights reserved.
